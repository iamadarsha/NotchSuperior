...
You can contribute in many ways: writing code, improving documentation, reporting bugs, requesting features, or creating tutorials and blog posts. Every contribution, large or small, helps make NotchSuperior better.
...
Please submit all translations to [Crowdin](https://crowdin.com/project/notch-superior). New strings added to the `dev` branch from code changes will sync automatically to Crowdin, and Crowdin will automatically open a new PR with translations to allow us to integrate them.
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/{your-username}/NotchSuperior.git
   cd NotchSuperior
   ```
...
- Join our [community Discord server](https://discord.gg/c8JXA7qrPm)

---

Thank you for contributing to NotchSuperior! Your efforts help make this project better for everyone. 🎉
